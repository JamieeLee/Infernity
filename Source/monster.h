...
void __fastcall PlaceUniqueMonst(int uniqindex, int miniontype, int unpackfilesize,bool forceplace, int x, int y);
...
void __fastcall SetMapMonsters(unsigned char *pMap, int startx, int starty, std::string msg);
